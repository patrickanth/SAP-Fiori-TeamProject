		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#gestioneclientigestioneclienti-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"gestioneclientigestioneclienti-display": {
								"semanticObject": "gestioneclientigestioneclienti",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=gestioneclienti.gestioneclienti",
									"url": sap.ui.require.toUrl("gestioneclienti/gestioneclienti")
								}
							}
						}
					}
